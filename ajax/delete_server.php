<?php
/**
 * Provides an ajax request to delete the given solr server entry.
 *
 * @copyright Christian Ackermann (c) 2010 - End of life
 * @author Christian Ackermann <prdatur@gmail.com>
 * @package modules.solr.ajax
 * @category Module.Solr
 */
class AjaxSolrDeleteServer extends AjaxModul {
	...
	public function run() {
		...
		$server_obj = new SolrServerObj($params->id);
